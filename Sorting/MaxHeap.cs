...
namespace Sorting
{
    public class MaxHeap
    {
        ...
        private void RecalculateDown()
        {
            ...
            {
                int largest = LeftChildIndex(parent);
                if (HasRightChild(parent) && LeftChild(parent) < RightChild(parent))
                {
                    largest = RightChildIndex(parent);
                }

                if (_elements[largest] < _elements[parent])
                {
                    break;
                }
